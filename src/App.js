  ...
  return (
    <>
      ...
      <section id="features">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <h3>Pro Equipment</h3>
            <p>
              Fully-equipped studio with professional PA system, drum kit, 
          ...
          <div className="feature-card">
            ...
            <p>
              Soundproof room with custom acoustic treatment designed for 
          ...
          <div className="feature-card">
            ...
            <p>
              Conveniently located in St John's with easy access, indoor parking, 
          ...
          <div className="feature-card">
            ...
            <p>
              $300 for one day per week, $350 for two days per week.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{maxWidth: '1400px', margin: '0 auto'}}>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <h3>Included Gear</h3>
              <p>
                PA system with mics and stands, 5-piece drum set, and 50W guitar amp 
                (clone of Soldano SLO 100). Ready to plug in and play.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">🚗</div>
              <h3>Easy Load-In</h3>
              <p>
                Drive right up to the front door for super easy load-in and load-out. 
            ...
            <div className="feature-card">
              ...
              <h3>24/7 Access</h3>
              <p>
                Keypad locks provide secure access any time, day or night. 
                Security cameras keep the space safe.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                A/C and heat keep you comfortable year-round, no matter 
                how long your session runs.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">💡</div>
              <h3>RGB Lighting</h3>
              <p>
                Control the vibe with customizable RGB LED lighting. 
                Set the mood for your rehearsal or recording.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">🍕</div>
              ...
              <p>
                On-site brewery and restaurant (Occidental Brewing). Kitchen with 
                fridge/freezer, microwave, and oven. Free WiFi and restrooms.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="gallery" id="gallery">
        <h2 className="section-title" style={{color: 'white'}}>Our Studio</h2>
      ...
      <section id="availability" style={{background: 'var(--bg)', padding: '5rem 2rem'}}>
        <div style={{maxWidth: '1200px', margin: '0 auto'}}>
          ...
          <p style={{fontSize: '1.2rem', color: 'var(--text-light)', marginBottom: '2rem', maxWidth: '800px'}}>
            See our current booking schedule below. Busy times are blocked out - 
            open slots mean the studio is available for you!
          </p>
          <div className="calendar-container">
            <iframe 
              src="https://calendar.google.com/calendar/embed?height=700&wkst=1&ctz=America%2FLos_Angeles&showPrint=0&title=Studio%20Availability&showTz=0&src=bndyZWhlYXJzYWxjYWxlbmRhckBnbWFpbC5jb20&color=%237986cb" 
              style={{borderWidth: 0}} 
              width="1200" 
              height="700" 
              frameBorder="0" 
