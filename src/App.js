      ...
      <section id="features">
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            ...
            <p>
              200 sq ft soundproof room with custom acoustic treatment designed for 
          ...
          <div className="feature-card">
            ...
            <h3>Safe & Secure</h3>
            <p>
              All tenants must pass a background check, ensuring a safe and 
          ...
          <div className="feature-card">
            ...
            <p>
              ...
              $150 non-refundable deposit required upon signup.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="availability" style={{background: 'var(--bg)', padding: '5rem 2rem'}}>
        <div style={{maxWidth: '1200px', margin: '0 auto'}}>
          ...
          <p style={{fontSize: '1.2rem', color: 'var(--text-light)', marginBottom: '2rem', maxWidth: '800px'}}>
            Browse our studio schedule below to see what times are available. Green slots are 
            open for booking - red slots are already reserved. Ready to reserve your time? Use 
